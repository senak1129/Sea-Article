...
const (
	...
	ArticleService_GetPresignedUploadUrl_FullMethodName = "/article.ArticleService/GetPresignedUploadUrl"
)
...
func (c *articleServiceClient) GetPresignedUploadUrl(ctx context.Context, in *GetPresignedUploadUrlRequest, opts ...grpc.CallOption) (*GetPresignedUploadUrlResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPresignedUploadUrlResponse)
	err := c.cc.Invoke(ctx, ArticleService_GetPresignedUploadUrl_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedArticleServiceServer) GetPresignedUploadUrl(context.Context, *GetPresignedUploadUrlRequest) (*GetPresignedUploadUrlResponse, error) {
...
func _ArticleService_GetPresignedUploadUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPresignedUploadUrlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArticleServiceServer).GetPresignedUploadUrl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArticleService_GetPresignedUploadUrl_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServiceServer).GetPresignedUploadUrl(ctx, req.(*GetPresignedUploadUrlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArticleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ArticleService_GetPresignedUploadUrl_Handler,
		},
	},
