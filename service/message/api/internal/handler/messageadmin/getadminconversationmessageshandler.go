...
func GetAdminConversationMessagesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := messageadmin.NewGetAdminConversationMessagesLogic(r.Context(), svcCtx)
		resp, err := l.GetAdminConversationMessages(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
