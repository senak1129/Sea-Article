...
const (
	...
	AdminService_CreateInviteCode_FullMethodName  = "/admin.AdminService/CreateInviteCode"
...
func (c *adminServiceClient) CreateInviteCode(ctx context.Context, in *CreateInviteCodeReq, opts ...grpc.CallOption) (*CreateInviteCodeResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateInviteCodeResp)
...
func (c *adminServiceClient) Logout(ctx context.Context, in *LogoutReq, opts ...grpc.CallOption) (*LogoutResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogoutResp)
...
type AdminServiceServer interface {
	...
	CreateInviteCode(context.Context, *CreateInviteCodeReq) (*CreateInviteCodeResp, error)
...
func (UnimplementedAdminServiceServer) CreateInviteCode(context.Context, *CreateInviteCodeReq) (*CreateInviteCodeResp, error) {
...
func (UnimplementedAdminServiceServer) Logout(context.Context, *LogoutReq) (*LogoutResp, error) {
...
func _AdminService_CreateInviteCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).CreateInviteCode(ctx, req.(*CreateInviteCodeReq))
	}
	return interceptor(ctx, in, info, handler)
}
